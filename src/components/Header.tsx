...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 z-50 w-full bg-white/80 backdrop-blur-sm shadow">
      {/* Flex wrapper: logo left, nav right */}
      <div className="flex items-center justify-between w-full px-4 sm:px-6 lg:px-10 py-5 sm:py-6">
        {/* Left: Logo + Name */}
        <div className="flex items-center space-x-3">
          <img
            src="/logo.png"
            alt="Restaurant Logo"
            className="h-16 w-16 sm:h-18 sm:w-18 object-contain rounded-full border-2 border-yellow-500 shadow bg-white"
          />
          <div>
      ...
      {isMenuOpen && (
        <div className="lg:hidden bg-white/90 backdrop-blur-sm shadow-inner px-4 py-4 space-y-4 text-base font-medium">
          <nav className="flex flex-col space-y-3">
            <a href="#home" className="text-gray-800 hover:text-yellow-600">
              Home
            </a>
            <a href="#about" className="text-gray-800 hover:text-yellow-600">
              About
            </a>
            <a href="#menu" className="text-gray-800 hover:text-yellow-600">
              Menu
            </a>
            <a
              href="#founder"
