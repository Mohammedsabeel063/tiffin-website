    ...
    <section id="about" className="py-20 bg-white w-full">
      <div className="w-full px-4 sm:px-6 md:px-12 max-w-[1440px] mx-auto">
        ...
        <div className="text-center mb-16 animate-fade-in-up">
          <h2 className="text-3xl md:text-5xl font-cinzel text-gray-900 mb-4 tracking-wide">
            About{' '}
            <span className="font-cinzel font-bold text-yellow-400 text-4xl md:text-5xl tracking-tight">
              M&F Kitchen
            </span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-10 items-center mb-20 animate-fade-in-up max-w-[90%] xl:max-w-[1200px] mx-auto">
          ...
          <div className="space-y-6 text-sm sm:text-base md:text-lg text-gray-700 leading-relaxed">
            <h3 className="text-xl md:text-3xl font-semibold text-gray-900">Our Mission</h3>
            <p>
            ...
            <div className="flex items-center space-x-4 pt-6">
              ...
              />
              <div>
                <p className="font-cinzel text-lg sm:text-xl font-semibold text-gray-800">
                  M&F Kitchen
                </p>
                <p className="text-gray-600 text-sm sm:text-base">Ghar Jaisa Khana. Cloud Mein.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8 mb-20 text-center animate-slide-up">
          {[
            ...
            <div key={i} className="bg-yellow-50 p-6 sm:p-10 rounded-2xl shadow hover:shadow-xl transition">
              {item.icon}
              <h4 className={`text-lg sm:text-xl font-bold ${isOpen ? 'text-green-600' : 'text-red-500'} mb-1`}>
                {item.title}
              </h4>
        ...
        {/* Why Choose Us */}
        <div className="text-center animate-fade-in-up max-w-6xl mx-auto">
          <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold text-gray-800 mb-6">
            Why Choose Us?
          </h3>
          <p className="text-xs sm:text-sm md:text-base lg:text-lg text-gray-600 mb-12 max-w-3xl mx-auto leading-relaxed px-2 sm:px-4">
            Miss home? We’re here with a warm dabba — wholesome, mom-style food at your door.
          </p>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-10">
            {[
              ...
              <div key={idx} className="bg-white shadow-md p-6 sm:p-8 rounded-xl hover:shadow-lg transition max-w-sm mx-auto">
                {item.icon}
                <h4 className="font-semibold text-gray-800 text-base sm:text-lg md:text-xl lg:text-2xl mb-2">
                  {item.title}
                </h4>
